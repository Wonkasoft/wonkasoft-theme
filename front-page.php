	...
	<section id="above-fold">
		...
		<section id="logos-section">
			<div class="container-fluid">
				<div class="row">
					<?php
					$brand_section_logo_1 = ( get_theme_mod( 'brand_section_logo_1' ) ) ? '<img src="'.get_theme_mod( 'brand_section_logo_1' ).'" class="img-responsive block-center" alt="brand-logo" />' : ''; 
					$brand_section_logo_2 = ( get_theme_mod( 'brand_section_logo_2' ) ) ? '<img src="'.get_theme_mod( 'brand_section_logo_2' ).'" class="img-responsive block-center" alt="brand-logo" />' : ''; 
					$brand_section_logo_3 = ( get_theme_mod( 'brand_section_logo_3' ) ) ? '<img src="'.get_theme_mod( 'brand_section_logo_3' ).'" class="img-responsive block-center" alt="brand-logo" />' : ''; 
					$brand_section_logo_4 = ( get_theme_mod( 'brand_section_logo_4' ) ) ? '<img src="'.get_theme_mod( 'brand_section_logo_4' ).'" class="img-responsive block-center" alt="brand-logo" />' : ''; 
					$brand_section_logo_5 = ( get_theme_mod( 'brand_section_logo_5' ) ) ? '<img src="'.get_theme_mod( 'brand_section_logo_5' ).'" class="img-responsive block-center" alt="brand-logo" />' : ''; 
					?>
					<div class="col-sm text-center">
						<?php echo $brand_section_logo_1; ?>
					</div> <!-- /leftcol -->
					<div class="col-sm text-center">
						<?php echo $brand_section_logo_2; ?>
					</div> <!-- /leftcol -->
					<div class="col-sm text-center">
						<?php echo $brand_section_logo_3; ?>
					</div> <!-- /leftcol -->
					<div class="col-sm text-center">
						<?php echo $brand_section_logo_4; ?>
					</div> <!-- /leftcol -->
					<div class="col-sm text-center">
						<?php echo $brand_section_logo_5; ?>
					</div> <!-- /leftcol -->
				</div> <!-- /row -->
			</div> <!-- /container-fluid -->
	...
	<div class="container-fluid">
		...
		<?php if ( !is_active_sidebar('our-team') ):?>
			...
			<?php
				...
				<div class="row w-our-team">
					<div class="col d-none d-md-inline-block text-center">
						<div class="row row-of-modules">
							<?php
							if(is_active_sidebar('our-team')){
								dynamic_sidebar('our-team');
							}
						?>	
					</div> <!-- /row row-of-modules -->
				...
				<?php
   	endif //  End IF for Our team section
   	?>
   </div> <!-- /container-fluid -->
